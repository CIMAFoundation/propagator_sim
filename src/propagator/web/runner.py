...
def schedule_actions(
    ...
    if not request.actions:
        return
    non_vegetated = FUEL_SYSTEM_LEGACY.get_non_vegetated()
...
def run_loop(simulator, job: JobState) -> None:
