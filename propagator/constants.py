...
VEG_MODIFICATION_TAG = 'veg_modification'
VEG_BROADLEAVES_TAG = 'veg_broadleaves'
VEG_SHRUBS_TAG = 'veg_shrubs'
VEG_BARE_SOIL_TAG = 'veg_bare_soil'
VEG_GRASS_TAG = 'veg_grass'
VEG_CONIFERS_TAG = 'veg_conifers'
VEG_CROPS_TAG = 'veg_crops'
VEG_NO_FIRE_BROADLEAVES_TAG = 'veg_no_fire_broadleaves'
