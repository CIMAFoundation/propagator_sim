...
export class Propagator {
     ...
     */
    constructor(rows: number, cols: number, veg: Int32Array, dem: Float64Array, realizations: number, seed: number, do_spotting: boolean, cellsize: number, ros_model: string, moisture_model: string);
    /**
...
export interface InitOutput {
    ...
    readonly propagator_new: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number) => [number, number, number];
